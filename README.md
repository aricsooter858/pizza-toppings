...
This program allows the user to select pizza toppings for a pizza. Once an order is added it is shown with the toppings selected. The pizza orders can
be removed or edited and updated. The pizza order data is stored in local storage on the browser.
